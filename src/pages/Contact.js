        ...
        <div className="col-md-8">
          ...
          <div className="col-md-6">
            <div className="contact-intro">
							<p>Please feel free to reach out through one of the following methods to discuss my portfolio or experience further. Thank you</p>
              <ul className="contact-list">
                   <li className="contact-links">
                  <a href={ mailLink } target="_blank" rel="noreferrer"><i><FaEnvelope style={iconStylesContact}/></i>{ about.contact.email }</a>
                </li> 
                <li className="contact-links">
                  <a href={ phoneLink } target="_blank" rel="noreferrer"><i><FaPhoneAlt style={iconStylesContact}/></i>{ about.contact.phone }</a>
                </li> 
                <li className="contact-links">
